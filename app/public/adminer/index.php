...
call_user_func(
	function () {
		$container = call_user_func(
			function () : Nette\Di\Container {
				return call_user_func(
					function (Nette\Configurator $configurator) : Nette\Di\Container {
						return call_user_func(
							...
							(
								...
								if ( ! $configurator->isDebugMode()) {
									call_user_func(
										function (Nette\Application\Application $application) {
											$application->run();
											exit;
										},
		...
		call_user_func(
			function (Nextras\Dbal\Connection $connection) {
