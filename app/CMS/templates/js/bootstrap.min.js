...
+function(a) {
    ...
    b.DEFAULTS = {interval: 5e3, pause: "hover"}, b.prototype.cycle = function(b) {
    ...
    b.DEFAULTS = {backdrop: !0, keyboard: !0, show: !0}, b.prototype.toggle = function() {
    ...
    b.DEFAULTS = {animation: !0, placement: "top", selector: !1, template: '<div class="tooltip"><div class="tooltip-arrow"></div><div class="tooltip-inner"></div></div>', trigger: "hover focus", title: "", delay: 0, html: !1, container: !1}, b.prototype.init = function(b, c, d) {
        ...
        if (this.hasContent() && this.enabled) {
            ...
            var p = "bottom" == d ? {top: g.top + g.height, left: g.left + g.width / 2 - h / 2} : "top" == d ? {top: g.top - i, left: g.left + g.width / 2 - h / 2} : "left" == d ? {top: g.top + g.height / 2 - i / 2, left: g.left - h} : {top: g.top + g.height / 2 - i / 2, left: g.left + g.width};
