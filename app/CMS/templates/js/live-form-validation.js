...
LiveForm.setUpHandlers = function(el) {
    ...
    if (!$(el).hasClass(this.options.alertValidation)) {
        var self = this;
        ...
        el.onkeydown = function(event) {
            if (self.options.wait >= 200) {
                $(self).closest('.row').removeClass(self.options.controlErrorClass);
...
LiveForm.addError = function(el, message) {
    ...
    $(el).closest('.row').addClass(this.options.controlErrorClass);
...
LiveForm.removeError = function(el) {
    $(el).closest('.row').removeClass(this.options.controlErrorClass);
